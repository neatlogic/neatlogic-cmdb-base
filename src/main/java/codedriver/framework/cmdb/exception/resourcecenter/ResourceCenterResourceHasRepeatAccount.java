 ...
 **/
public class ResourceCenterResourceHasRepeatAccount extends ApiRuntimeException {

    private static final long serialVersionUID = 6934793951984585148L;

    public ResourceCenterResourceHasRepeatAccount(String resourceId, String account, String protocol) {
