...
public class CustomViewGlobalAttrVo implements Serializable {
    ...
    private GlobalAttrVo attrVo;

    public CustomViewGlobalAttrVo() {

    }

    public CustomViewGlobalAttrVo(Long _customViewId) {
        this.customViewId = _customViewId;
    }

    public CustomViewGlobalAttrVo(JSONObject jsonObj) {
    ...
    public void setGlobalAttrVo(GlobalAttrVo attrVo) {
        this.attrVo = attrVo;
    }
    ...
    public JSONObject getCondition() {
        if (condition == null && StringUtils.isNotBlank(conditionStr)) {
            try {
                condition = JSON.parseObject(conditionStr);
