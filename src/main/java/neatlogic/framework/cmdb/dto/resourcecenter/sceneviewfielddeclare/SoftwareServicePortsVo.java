...
@ResourceType(name = "scence_softwareservice_ports", label = "软件服务服务端口场景", functionPathList = {"下载作业剧本节点接口/autoexec/job/phase/nodes/download"})
@ResourceType(name = "scence_osservice_ports", label = "操作系统服务端口场景", functionPathList = {"下载作业剧本节点接口/autoexec/job/phase/nodes/download"})
