...
@ResourceType(name = "scence_application_asset_list_detail", label = "nfcdrcs.applicationassetlistdetailvo.resourcetype.scenceapplicationassetlistdetail.label", isMultiple = true, moduleId= "cmdb", functionPathList = {"nfcdrcs.functionpath.applicationlist"})
