...
@Deprecated
//@ResourceType(name = "scence_appinstance_detail_cluster", label = "应用实例详情及集群场景", moduleId= "cmdb", functionPathList = {"配置管理/应用清单"})
@ResourceType(name = "scence_dbinstance_detail_cluster", label = "DB实例详情及集群场景", moduleId= "cmdb", functionPathList = {"配置管理/应用清单"})
