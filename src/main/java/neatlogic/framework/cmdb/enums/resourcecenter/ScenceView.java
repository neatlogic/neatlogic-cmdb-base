...
public enum ScenceView {
    ...
    SCENCE_IPOBJECT_ENV_APPMODULE("scence_ipobject_env_appmodule", "enum.cmdb.scenceview.scence_ipobject_env_appmodule"),
    ...
    SCENCE_APPSYSTEM("scence_appsystem", "enum.cmdb.scenceview.scence_appsystem"),
    SCENCE_APPMODULE("scence_appmodule", "enum.cmdb.scenceview.scence_appmodule"),
    ...
    SCENCE_OS_SOFTWARESERVICE_ENV_APPMODULE("scence_os_softwareservice_env_appmodule", "enum.cmdb.scenceview.scence_os_softwareservice_env_appmodule"),
